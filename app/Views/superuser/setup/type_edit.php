    ...
    <div class="container-fluid d-sm-flex justify-content-between">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Edit Rooms Type</li>
            </ol>
        </nav>
    </div>
</div>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="name" class="form-control form-control-lg" value="<?= $type->name ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="code" class="form-control form-control-lg" value="<?= $type->code ?>" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">
                                    ...
                                    <div class="col-sm-9">
                                        <?php
                                        if ($type->facility != '') {
                                            $facility = unserialize($type->facility);
                                        } else {
                                            $facility = [];
                                        }
                                        ?>
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" name="facility[]" value="Free Coffee" id="customCheckBoxInline1" class="custom-control-input" <?= (in_array('Free Coffee', $facility)) ? 'checked' : '' ?>>
                                            <label class="custom-control-label" for="customCheckBoxInline1">Free Coffee</label>
                                        </div>
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" name="facility[]" value="Morning News Paper" id="customCheckBoxInline2" class="custom-control-input" <?= (in_array('Morning News Paper', $facility)) ? 'checked' : '' ?>>
                                            <label class="custom-control-label" for="customCheckBoxInline2">Morning News Paper</label>
                                        </div>
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" name="facility[]" value="WiFi" id="customCheckBoxInline3" class="custom-control-input" <?= (in_array('WiFi', $facility)) ? 'checked' : '' ?>>
                                            <label class="custom-control-label" for="customCheckBoxInline3">WiFi</label>
                                        </div>
                                        <div class="custom-control custom-checkbox custom-control-inline">
                                            <input type="checkbox" name="facility[]" value="Swimming Poll" id="customCheckBoxInline4" class="custom-control-input" <?= (in_array('Swimming Poll', $facility)) ? 'checked' : '' ?>>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="description" class="form-control form-control-lg"><?= $type->description ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="base_occupancy" class="form-control form-control-lg" value="<?= $type->base_occupancy ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="kids_occupancy" class="form-control form-control-lg" value="<?= $type->kids_occupancy ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="higher_occupancy" class="form-control form-control-lg" value="<?= $type->higher_occupancy ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-5">
...
<script>
    let preloaded = [
        <?php
        if ($type->gallery != '') {
            $gallery = unserialize($type->gallery);
            $no = 1;
