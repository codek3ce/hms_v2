                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select name="rooms_type_id" class="form-control form-control-lg">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="number" name="mon" class="form-control form-control-lg" id="dayRegular1" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="">Tuesday</label>
                                                <input type="number" name="tue" class="form-control form-control-lg" id="dayRegular2" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="">Wednesday</label>
                                                <input type="number" name="wed" class="form-control form-control-lg" id="dayRegular3" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="">Thursday</label>
                                                <input type="number" name="thu" class="form-control form-control-lg" id="dayRegular4" required>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            <div class="col-md-3">
                                                <label for="">Friday</label>
                                                <input type="number" name="fri" class="form-control form-control-lg" id="dayRegular5" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="">Saturday</label>
                                                <input type="number" name="sat" class="form-control form-control-lg" id="dayRegular6" required>
                                            </div>
                                            <div class="col-md-3">
                                                <label for="">Sunday</label>
                                                <input type="number" name="sun" class="form-control form-control-lg" id="dayRegular7" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
