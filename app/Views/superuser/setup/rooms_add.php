    ...
    <div class="container-fluid d-sm-flex justify-content-between">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add New Rooms</li>
            </ol>
        </nav>
    </div>
</div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="number" class="form-control form-control-lg numberRoom" required>
                                        <div class="text-danger">enter the room number separated by commas. eg: 01, 02, 10, 12</div>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="status" class="form-control form-control-lg">
                                            <option value="Occupied Dirty (OD)">Occupied Dirty (OD)</option>
                                            <option value="Occupied Clean (OC) [Ready For Booking]">Occupied Clean (OC) [Ready For Booking]</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script>
    $("input.numberRoom").tagsinput('items');
